...
(async () => {
  ...
  try {
    ...
    assert.equal(await page.locator('.theme-moon').evaluate(el => getComputedStyle(el).opacity), '0');
    assert.equal(await page.locator('.about-wordmark .brand-name').evaluate(el => getComputedStyle(el).color), 'rgb(240, 242, 234)');
    ...
    assert.equal(await page.locator('.theme-moon').evaluate(el => getComputedStyle(el).opacity), '1');
    assert.equal(await page.locator('.theme-sun').evaluate(el => getComputedStyle(el).opacity), '0');
    assert.equal(await page.locator('.about-wordmark .brand-name').evaluate(el => getComputedStyle(el).color), 'rgb(24, 60, 45)');
    assert.equal(await page.locator('.site-footer .brand-name').evaluate(el => getComputedStyle(el).color), 'rgb(24, 60, 45)');
